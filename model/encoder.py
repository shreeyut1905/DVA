...
from .neural_operations import OPS,EncCombinerCell,DeCombinerCell,Conv2D,get_skip_connection
...
class Encoder(nn.Module):
    def __init__(self,args):
        ...
        self.mult = args.mult 
        self.prediciton_length = args.prediction_length
        ...
        c_scaling = 2** (self.num_preprocess_blocks)
        ...
        self.enc0 = nn.Sequential(nn.ELU(),Conv2D(self.num_channels_enc * self.mult,self.num_channels_enc * self.mult,kernel_size=1,bias=True),nn.ELU())
    ...
    def init_decoder_tower(self,mult):
        ...
        for g in range(self.groups_per_scale):
            ...
            cell = DeCombinerCell(num_c,self.num_latent_per_group,num_c,cell_type='combiner_dec')
            dec_tower.append(cell)
        self.mult = mult 
        return dec_tower 
